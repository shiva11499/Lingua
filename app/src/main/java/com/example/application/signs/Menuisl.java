...
public class Menuisl extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_menuisl);

        TextView Go = (TextView) findViewById(R.id.islshift);

        mVoiceInputTv = (TextView) findViewById(R.id.voiceInputisl);
        ...
        switch (requestCode) {
            case REQ_CODE_SPEECH_INPUT: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    String info=mVoiceInputTv.getText().toString();
                    info=info+"@";
